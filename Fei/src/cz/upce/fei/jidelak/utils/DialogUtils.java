...
public class DialogUtils {
	...
	public static Dialog getNewWeekRefreshDialog(Context ctx, final RefreshViewHelper imageView, final IJidelnicekActivityController ctrl) {
		DialogInterface.OnClickListener listener = new DialogInterface.OnClickListener() {
	...
	public static Dialog getRefreshDialog(Context ctx) {
		AlertDialog.Builder builder = new AlertDialog.Builder(ctx);
		builder.setTitle(ctx.getText(R.string.dlg_reload_needed_title))
				.setCancelable(false)
				.setMessage(R.string.dlg_reload_needed)
				.setPositiveButton(android.R.string.ok, null);
